  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:flex items-center justify-end gap-12">
        ...
        <button className="hidden lg:block lg:px-7 lg:py-3 lg:text-md xl:px-8 xl:py-3 tracking-[1.7px]  xl:text-lg font-bold font-montserrat rounded-full bg-primary text-white hover:bg-white hover:text-primary transition-all ease-in-out duration-300 hover:border hover:border-primary">
          Sign Up
        </button>
      </div>
    </div>
