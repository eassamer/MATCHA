...
export const AboutUs = () => {
  return (
    <div className="w-full h-fit px-24 py-8 flex flex-col items-center justify-start gap-12">
      <h1 className="font-bold font-montserrat tracking-[1.7px] text-[45px] text-black">
        About Us
      </h1>
      <div className="w-[700px] bg-white h-[420px] rounded-[13px] [box-shadow:-13px_35px_0px_0px_rgba(193,61,136,1)] flex items-center justify-center px-14">
        <div className="w-1/2 h-full flex items-center justify-center">
          <Image src="/About.svg" alt="about-us" width={300} height={300} />
        </div>
        <div className="w-1/2 h-full  py-6 font-medium flex flex-col items-start justify-center  pl-4 gap-4">
