const queries = {
  USE_DB: "USE ?",
  ADD_NEW_USER:
    "INSERT INTO users (userId, firstName, lastName, email, lastLocation, password) VALUES (uuid(), ?, ?, ?, ?, ?)",
  ...
  UPDATE_USER_LASTLOCATION: "UPDATE users SET lastLocation = ? WHERE userId = ?",
  ...
  ADD_IMAGE: `INSERT INTO images (locationUrl, ownerId) VALUES (?, ?)`,
  DELETE_IMAGE: `DELETE FROM images WHERE imageId = ?`,
  FIND_IMAGES_BY_USER: `SELECT * FROM images WHERE ownerId = ?`,
